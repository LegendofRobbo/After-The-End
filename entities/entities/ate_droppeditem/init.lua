...
if (CalculateWeight(activator) + ref.Weight) > (40 + ((activator.StatStrength or 0) * 2)) then SendChat(activator, "You don't have enough space for this item!") return false end
