...
if client.Bounty < 1 then SystemMessage(client, "You don't have any bounty to cash in!", Color(255,205,205,255), true) return false end

client.Money = math.floor(tonumber(client.Money)) + tonumber(client.Bounty)
SystemMessage(client, "You cashed in your bounty and recieved "..tonumber(client.Bounty).." "..Config[ "Currency" ].."s!", Color(205,255,205,255), true)
client.Bounty = 0
