...
local function RecvPlayerKilled()
	...
	if attacker == "npc_nextbot_regularzombie" then attacker = "Shambling Zombie" end
	if attacker == "npc_nextbot_leaper" then attacker = "Leaper Zombie" end
	if attacker == "npc_nextbot_tank" then attacker = "Tank Zombie" end
	if attacker == "npc_nextbot_wraith" then attacker = "Wraith Zombie" end
	if attacker == "npc_nextbot_fleshpile" then attacker = "Fleshpile Zombie" end
	if attacker == "npc_nextbot_master" then attacker = "Zombie Lord" end
...
function GM:AddDeathNotice( Victim, team1, Inflictor, Attacker, team2 )
	...
	if ( team2 == -1 ) then Death.pteam2 = "The Horde"
