...
TraderFrame.Paint = function()
    ...
    MyWeight:SetText("Currently Carrying: "..CalculateWeightClient().."kg / "..40 + ((Perks.Strength or 0) * 2).."kg")
...
for k, v in SortedPairsByMemberValue( ItemsList, "Cost" ) do
    ...
    ItemCost:SetText( "Cost: ".. math.floor((v.Cost * (1 - ((Perks.Barter or 0) * 0.02)))) )
...
local function DoSellPanel()
    ...
    for k, v in SortedPairsByMemberValue( LocalInventory, "Weight", true ) do
            ...
            local icost = ((ItemsList[k]["Cost"] or 0) * (0.3 + ((Perks.Barter or 0) * 0.02)) ) or 0
